...
const ALL_COMMANDS = [
  ...
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "balance", desc: "Ver tu dinero en efectivo y banco.", usage: "/balance [@usuario]" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "daily", desc: "Recoge tu recompensa diaria.", usage: "/daily" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "work", desc: "Trabaja para ganar dinero.", usage: "/work" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "pay", desc: "Transfiere dinero a otro usuario.", usage: "/pay @usuario [cantidad]" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "bank", desc: "Deposita o retira del banco.", usage: "/bank deposit|withdraw [cantidad]" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "rich", desc: "Los más ricos del servidor.", usage: "/rich" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "slots", desc: "Máquina tragamonedas.", usage: "/slots [apuesta]" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "rob", desc: "Intenta robar a otro usuario.", usage: "/rob @usuario" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "blackjack", desc: "Juego de blackjack.", usage: "/blackjack [apuesta]" },
  { category: "Economía", emoji: "💰", icon: Coins, color: "#FEE75C", name: "roulette", desc: "Ruleta de colores.", usage: "/roulette [apuesta] [color]" },

  { category: "Niveles", emoji: "⭐", icon: BarChart3, color: "#57F287", name: "rank", desc: "Ver tu rango y nivel.", usage: "/rank ver/logros/misiones/reclamar" },
  { category: "Niveles", emoji: "⭐", icon: BarChart3, color: "#57F287", name: "leaderboard", desc: "Tabla de clasificación.", usage: "/top niveles/voz" },

  { category: "Diversión", emoji: "🎮", icon: Gamepad2, color: "#FF6B6B", name: "8ball", desc: "Pregunta a la bola mágica.", usage: "/8ball [pregunta]" },
  { category: "Diversión", emoji: "🎮", icon: Gamepad2, color: "#FF6B6B", name: "meme", desc: "Meme aleatorio.", usage: "/meme" },
  { category: "Diversión", emoji: "🎮", icon: Gamepad2, color: "#FF6B6B", name: "ship", desc: "Compatibilidad entre usuarios.", usage: "/ship @user1 @user2" },
  ...
  { category: "Utilidad", emoji: "🔧", icon: Globe, color: "#FF8C42", name: "userinfo", desc: "Info detallada de un usuario.", usage: "/userinfo [@usuario]" },
  { category: "Utilidad", emoji: "🔧", icon: Globe, color: "#FF8C42", name: "serverinfo", desc: "Info del servidor.", usage: "/serverinfo" },
  { category: "Utilidad", emoji: "🔧", icon: Globe, color: "#FF8C42", name: "avatar", desc: "Muestra el avatar.", usage: "/avatar [@usuario]" },
  { category: "Utilidad", emoji: "🔧", icon: Globe, color: "#FF8C42", name: "botinfo", desc: "Estadísticas del bot.", usage: "/botinfo" },
  { category: "Utilidad", emoji: "🔧", icon: Globe, color: "#FF8C42", name: "ping", desc: "Latencia del bot.", usage: "/ping" },
  { category: "Utilidad", emoji: "🔧", icon: Globe, color: "#FF8C42", name: "help", desc: "Lista de comandos.", usage: "/help [comando]" },
