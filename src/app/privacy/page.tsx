      ...
      <div className="mx-auto max-w-4xl px-4">
        <FadeIn>
          ...
          <div className="mt-8 space-y-8 text-gray-400 leading-relaxed">
            <section><h2 className="text-xl font-semibold text-white mb-3">1. Información que Recopilamos</h2><p>Recopilamos información que nos proporcionas directamente: nombre, correo electrónico, nombre de usuario, contraseña (hasheada), información de pago (procesada por Stripe) y datos de perfil. También recopilamos datos de uso como páginas visitadas, progreso en cursos e información del dispositivo.</p></section>
            ...
            <section><h2 className="text-xl font-semibold text-white mb-3">3. Compartir Datos</h2><p>No vendemos tus datos personales. Podemos compartir datos con: Stripe (procesamiento de pagos), Vercel (hosting) y Cloudflare (CDN/seguridad). Estos proveedores están vinculados por acuerdos de procesamiento de datos.</p></section>
