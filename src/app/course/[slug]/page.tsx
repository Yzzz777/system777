...
const allCourses: Record<string, {
  ...
  "css-masterclass": {
    ...
    curriculum: [
      { title: "Fundamentos de CSS", lessons: [
        { title: "Selectores y especificidad", duration: "20 min", free: true, videoId: "yfoY53QqEnE", content: "CSS (Cascading Style Sheets) se usa para estilizar páginas HTML.\n\nTipos de selectores:\n\nSelector de elemento:\np { color: blue; }\n\nSelector de clase:\n.clase { color: red; }\n\nSelector de ID:\n#id { color: green; }\n\nSelectores descendentes:\ndiv p { color: yellow; }\n\nEspecificidad:\n1. Inline styles (1000)\n2. ID selectors (100)\n3. Class selectors (10)\n4. Element selectors (1)\n\nCuanto mayor sea la especificidad, el estilo tendrá más prioridad." },
  ...
  "javascript-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        ...
        { title: "Operadores y condicionales", duration: "25 min", free: true, videoId: "hdI2bq4jymc" },
        { title: "Bucles", duration: "20 min", free: false, videoId: "lfkJEeZNImg" }
      ]},
      { title: "Funciones y Objetos", lessons: [
        { title: "Funciones", duration: "35 min", free: false, videoId: "hdI2bq4jymc" },
        { title: "Objetos y arrays", duration: "40 min", free: false, videoId: "lfkJEeZNImg" }
      ]},
      { title: "DOM y Eventos", lessons: [
        { title: "Selección de elementos", duration: "25 min", free: false, videoId: "W6NZfCO5SIk" },
        { title: "Event listeners", duration: "30 min", free: false, videoId: "hdI2bq4jymc" }
      ]}
    ]
  },
  "react-complete": {
    ...
    curriculum: [
      { title: "Introducción a React", lessons: [
        ...
        { title: "Componentes y Props", duration: "35 min", free: true, videoId: "LXb3EKWsInQ" }
      ]},
      { title: "Hooks", lessons: [
        { title: "useState y useEffect", duration: "40 min", free: false, videoId: "Ke90Tje7VS0" },
        { title: "useContext y useReducer", duration: "45 min", free: false, videoId: "LXb3EKWsInQ" }
      ]}
    ]
  },
  "nextjs-mastery": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y estructura", duration: "25 min", free: true, videoId: "mTkaMFVz8xQ" },
        { title: "App Router vs Pages Router", duration: "30 min", free: true, videoId: "mTkaMFVz8xQ" }
      ]}
    ]
  },
  "python-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        ...
        { title: "Variables y tipos", duration: "25 min", free: true, videoId: "_uQrJ0TkZlc" }
      ]}
    ]
  },
  "ethical-hacking": {
  ...
  "linux-admin": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "Instalación de Linux", duration: "25 min", free: true, videoId: "sXbXT2GrOeA", content: "Linux es un sistema operativo de código abierto.\n\nDistribuciones populares:\n- Ubuntu: Para principiantes\n- Debian: Muy estable\n- CentOS/RHEL: Para servidores\n- Kali Linux: Para seguridad\n\nComandos básicos:\nls - Listar archivos\ncd - Cambiar directorio\npwd - Directorio actual\nmkdir - Crear carpeta\nrm - Eliminar archivos\ncp - Copiar archivos\nmv - Mover/renombrar\nchmod - Cambiar permisos\nchown - Cambiar propietario\nsudo - Ejecutar como root" },
        { title: "Terminal básica", duration: "30 min", free: true, videoId: "sXbXT2GrOeA" }
      ]}
    ]
  },
  "discord-js-bot": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Setup de Discord.js", duration: "25 min", free: true, videoId: "S5V11wAMHJI" },
        { title: "Primer bot", duration: "30 min", free: true, videoId: "S5V11wAMHJI" }
      ]}
    ]
  },
  "nodejs-backend": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Node.js y npm", duration: "20 min", free: true, videoId: "TlB_eWDSz4U" },
        { title: "Express.js", duration: "30 min", free: true, videoId: "TlB_eWDSz4U" }
      ]}
    ]
  },
  "postgresql-database": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación de PostgreSQL", duration: "15 min", free: true, videoId: "2bKpSN3WJm0" },
        { title: "SELECT y WHERE", duration: "25 min", free: true, videoId: "2bKpSN3WJm0" }
      ]}
    ]
  },
  "kubernetes-docker": {
  ...
  "penetration-testing": {
    ...
    curriculum: [
      { title: "Preparación", lessons: [
        { title: "Lab de pentesting", duration: "30 min", free: true, videoId: "fNzpcB7OCx4" },
        { title: "Metodología PTES", duration: "25 min", free: true, videoId: "inKMu4yPdI0" }
      ]}
    ]
  },
  "network-security": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Modelo OSI y seguridad", duration: "25 min", free: true, videoId: "inKMu4yPdI0" },
        { title: "Herramientas de escaneo", duration: "30 min", free: true, videoId: "inKMu4yPdI0" }
      ]}
    ]
  },
  "react-native-mobile": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "React Native vs Flutter", duration: "20 min", free: true, videoId: "Ke90Tje7VS0" },
        { title: "Setup con Expo", duration: "25 min", free: true, videoId: "LXb3EKWsInQ" }
      ]}
    ]
  },
  "python-django": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y primer proyecto", duration: "25 min", free: true, videoId: "rfscVS0vtbw" },
        { title: "Models y ORM", duration: "35 min", free: true, videoId: "_uQrJ0TkZlc" }
      ]}
    ]
  },
  "cloud-aws": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "AWS Global Infrastructure", duration: "20 min", free: true, videoId: "SOT_EX5LrvM" },
        { title: "Creando tu cuenta AWS", duration: "15 min", free: true, videoId: "SOT_EX5LrvM" }
      ]}
    ]
  },
  "malware-analysis": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "Tipos de malware", duration: "25 min", free: true, videoId: "inKMu4yPdI0" },
        { title: "Setup de laboratorio", duration: "30 min", free: true, videoId: "inKMu4yPdI0" }
      ]}
    ]
  },
  "git-github-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación de Git", duration: "10 min", free: true, videoId: "RGOj5yH7evk", content: "Git es un sistema de control de versiones distribuido.\n\nInstalación:\nUbuntu: sudo apt install git\nMac: brew install git\nWindows: git-scm.com\n\nConfiguración:\ngit config --global user.name \"Tu Nombre\"\ngit config --global user.email \"tu@email.com\"\n\nComandos básicos:\ngit init - Inicializar repositorio\ngit add . - Agregar archivos\ngit commit -m \"mensaje\" - Guardar cambios\ngit status - Ver estado\ngit log - Ver historial" },
        { title: "Primer commit", duration: "15 min", free: true, videoId: "RGOj5yH7evk" }
      ]}
    ]
  },
  "typescript-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "¿Por qué TypeScript?", duration: "15 min", free: true, videoId: "BwuLxPH8IDs" },
        { title: "Tipos básicos", duration: "25 min", free: true, videoId: "BwuLxPH8IDs" }
      ]}
    ]
  },
};
