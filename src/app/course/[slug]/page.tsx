...
const allCourses: Record<string, {
  ...
  "javascript-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Variables y tipos de datos", duration: "30 min", free: true, videoId: "Tn6-PIqc4UM", content: "JavaScript tiene 3 formas de declarar variables:\n\nlet - Variable que puede cambiarse\nconst - Constante que no puede cambiarse\nvar - Forma antigua (evitar usar)\n\nlet nombre = \"Juan\";\nconst PI = 3.1416;\n\nTipos de datos:\n- String: \"texto\" o 'texto'\n- Number: 42, 3.14\n- Boolean: true, false\n- Undefined: variable sin valor\n- Null: valor vacío intencional\n- Object: { clave: valor }\n- Array: [1, 2, 3]\n\ntypeof \"hola\" // \"string\"\ntypeof 42 // \"number\"\ntypeof true // \"boolean\"" },
        { title: "Operadores y condicionales", duration: "25 min", free: true, videoId: "Tn6-PIqc4UM" },
        { title: "Bucles", duration: "20 min", free: false, videoId: "Tn6-PIqc4UM" }
      ]},
      ...
      { title: "DOM y Eventos", lessons: [
        { title: "Selección de elementos", duration: "25 min", free: false, videoId: "0ik6X8DhWz8" },
        { title: "Event listeners", duration: "30 min", free: false, videoId: "0ik6X8DhWz8" }
      ]}
    ]
  },
  "react-complete": {
    ...
    curriculum: [
      { title: "Introducción a React", lessons: [
        { title: "Qué es React y JSX", duration: "30 min", free: true, videoId: "Ke90Tje7VS0", content: "React es una librería de JavaScript para construir interfaces de usuario.\n\nJSX es una extensión de JavaScript que parece HTML:\n\nfunction App() {\n  return (\n    <div>\n      <h1>Hola, React!</h1>\n      <p>Mi primera app con React</p>\n    </div>\n  );\n}\n\nJSX permite usar JavaScript dentro del HTML:\nfunction App() {\n  const nombre = \"Carlos\";\n  return (\n    <div>\n      <h1>Hola, {nombre}!</h1>\n      <p>2 + 2 = {2 + 2}</p>\n    </div>\n  );\n}" },
        { title: "Componentes y Props", duration: "35 min", free: true, videoId: "Ke90Tje7VS0" }
      ]},
      { title: "Hooks", lessons: [
        { title: "useState y useEffect", duration: "40 min", free: false, videoId: "w7emdDJEjM4" },
        { title: "useContext y useReducer", duration: "45 min", free: false, videoId: "w7emdDJEjM4" }
      ]}
    ]
  },
  "nextjs-mastery": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y estructura", duration: "25 min", free: true, videoId: "mTz0GXj8NN0" },
        { title: "App Router vs Pages Router", duration: "30 min", free: true, videoId: "mTz0GXj8NN0" }
      ]}
    ]
  },
  "python-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y configuración", duration: "15 min", free: true, videoId: "rfscVS0vtbw", content: "Python es un lenguaje de programación de alto nivel, fácil de aprender.\n\nInstalación:\n1. Ve a python.org/downloads\n2. Descarga Python 3.x\n3. Marca \"Add Python to PATH\"\n4. Haz clic en Install Now\n\nVerificar instalación:\npython --version\n\nTu primer programa:\nprint(\"¡Hola, Mundo!\")\n\nVariables:\nnombre = \"Carlos\"\nedad = 25\nprint(f\"Hola, soy {nombre} y tengo {edad} años\")" },
        { title: "Variables y tipos", duration: "25 min", free: true, videoId: "rfscVS0vtbw" }
      ]}
    ]
  },
  "ethical-hacking": {
  ...
  "linux-admin": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "Instalación de Linux", duration: "25 min", free: true, videoId: "sK0j2Lh9N7o", content: "Linux es un sistema operativo de código abierto.\n\nDistribuciones populares:\n- Ubuntu: Para principiantes\n- Debian: Muy estable\n- CentOS/RHEL: Para servidores\n- Kali Linux: Para seguridad\n\nComandos básicos:\nls - Listar archivos\ncd - Cambiar directorio\npwd - Directorio actual\nmkdir - Crear carpeta\nrm - Eliminar archivos\ncp - Copiar archivos\nmv - Mover/renombrar\nchmod - Cambiar permisos\nchown - Cambiar propietario\nsudo - Ejecutar como root" },
        { title: "Terminal básica", duration: "30 min", free: true, videoId: "sK0j2Lh9N7o" }
      ]}
    ]
  },
  "discord-js-bot": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Setup de Discord.js", duration: "25 min", free: true, videoId: "ZKm9Sx08fY" },
        { title: "Primer bot", duration: "30 min", free: true, videoId: "ZKm9Sx08fY" }
      ]}
    ]
  },
  "nodejs-backend": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Node.js y npm", duration: "20 min", free: true, videoId: "TlB_eWDSM4U" },
        { title: "Express.js", duration: "30 min", free: true, videoId: "TlB_eWDSM4U" }
      ]}
    ]
  },
  "postgresql-database": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación de PostgreSQL", duration: "15 min", free: true, videoId: "qx9V1f3056o" },
        { title: "SELECT y WHERE", duration: "25 min", free: true, videoId: "qx9V1f3056o" }
      ]}
    ]
  },
  "kubernetes-docker": {
    ...
    curriculum: [
      { title: "Docker", lessons: [
        { title: "Containers básicos", duration: "30 min", free: true, videoId: "3c-iBn73dDE" },
        { title: "Dockerfile", duration: "25 min", free: true, videoId: "3c-iBn73dDE" }
      ]}
    ]
  },
  "penetration-testing": {
    ...
    curriculum: [
      { title: "Preparación", lessons: [
        { title: "Lab de pentesting", duration: "30 min", free: true, videoId: "x6aoVvDxnys" },
        { title: "Metodología PTES", duration: "25 min", free: true, videoId: "x6aoVvDxnys" }
      ]}
    ]
  },
  "network-security": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Modelo OSI y seguridad", duration: "25 min", free: true, videoId: "qiQR5rTSjwU" },
        { title: "Herramientas de escaneo", duration: "30 min", free: true, videoId: "qiQR5rTSjwU" }
      ]}
    ]
  },
  "react-native-mobile": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "React Native vs Flutter", duration: "20 min", free: true, videoId: "0-S5aqeKa7A" },
        { title: "Setup con Expo", duration: "25 min", free: true, videoId: "0-S5aqeKa7A" }
      ]}
    ]
  },
  "python-django": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y primer proyecto", duration: "25 min", free: true, videoId: "F5mRW0jo-U4" },
        { title: "Models y ORM", duration: "35 min", free: true, videoId: "F5mRW0jo-U4" }
      ]}
    ]
  },
  "cloud-aws": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "AWS Global Infrastructure", duration: "20 min", free: true, videoId: "S3ll8Z2jYwg" },
        { title: "Creando tu cuenta AWS", duration: "15 min", free: true, videoId: "S3ll8Z2jYwg" }
      ]}
    ]
  },
  "malware-analysis": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "Tipos de malware", duration: "25 min", free: true, videoId: "bG4bEoTdP-k" },
        { title: "Setup de laboratorio", duration: "30 min", free: true, videoId: "bG4bEoTdP-k" }
      ]}
    ]
  },
  "git-github-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación de Git", duration: "10 min", free: true, videoId: "8JJ101D3knE", content: "Git es un sistema de control de versiones distribuido.\n\nInstalación:\nUbuntu: sudo apt install git\nMac: brew install git\nWindows: git-scm.com\n\nConfiguración:\ngit config --global user.name \"Tu Nombre\"\ngit config --global user.email \"tu@email.com\"\n\nComandos básicos:\ngit init - Inicializar repositorio\ngit add . - Agregar archivos\ngit commit -m \"mensaje\" - Guardar cambios\ngit status - Ver estado\ngit log - Ver historial" },
        { title: "Primer commit", duration: "15 min", free: true, videoId: "8JJ101D3knE" }
      ]}
    ]
  },
  "typescript-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "¿Por qué TypeScript?", duration: "15 min", free: true, videoId: "p6dO9u0M3MQ" },
        { title: "Tipos básicos", duration: "25 min", free: true, videoId: "p6dO9u0M3MQ" }
      ]}
    ]
  },
};
