...
const allCourses: Record<string, {
  ...
  "javascript-complete": {
    ...
    curriculum: [
      ...
      { title: "Funciones y Objetos", lessons: [
        ...
        { title: "Objetos y arrays", duration: "40 min", free: false, videoId: "hdI2bq4jymc" }
      ]},
      { title: "DOM y Eventos", lessons: [
        { title: "Selección de elementos", duration: "25 min", free: false, videoId: "rfscVS0vtbw" },
        { title: "Event listeners", duration: "30 min", free: false, videoId: "rfscVS0vtbw" }
      ]}
    ]
  },
  "react-complete": {
    ...
    curriculum: [
      ...
      { title: "Hooks", lessons: [
        { title: "useState y useEffect", duration: "40 min", free: false, videoId: "mTkaMFVz8xQ" },
        { title: "useContext y useReducer", duration: "45 min", free: false, videoId: "mTkaMFVz8xQ" }
      ]}
    ]
  },
  "nextjs-mastery": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y estructura", duration: "25 min", free: true, videoId: "pEfr8AtTqgYK" },
        { title: "App Router vs Pages Router", duration: "30 min", free: true, videoId: "pEfr8AtTqgYK" }
      ]}
    ]
  },
  "python-complete": {
  ...
  "linux-admin": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "Instalación de Linux", duration: "25 min", free: true, videoId: "pbkRfKfCqSg", content: "Linux es un sistema operativo de código abierto.\n\nDistribuciones populares:\n- Ubuntu: Para principiantes\n- Debian: Muy estable\n- CentOS/RHEL: Para servidores\n- Kali Linux: Para seguridad\n\nComandos básicos:\nls - Listar archivos\ncd - Cambiar directorio\npwd - Directorio actual\nmkdir - Crear carpeta\nrm - Eliminar archivos\ncp - Copiar archivos\nmv - Mover/renombrar\nchmod - Cambiar permisos\nchown - Cambiar propietario\nsudo - Ejecutar como root" },
        { title: "Terminal básica", duration: "30 min", free: true, videoId: "pbkRfKfCqSg" }
      ]}
    ]
  },
  "discord-js-bot": {
  ...
  "nodejs-backend": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Node.js y npm", duration: "20 min", free: true, videoId: "mTkaMFVz8xQ" },
        { title: "Express.js", duration: "30 min", free: true, videoId: "mTkaMFVz8xQ" }
      ]}
    ]
  },
  "postgresql-database": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación de PostgreSQL", duration: "15 min", free: true, videoId: "g817Gfhrq0U" },
        { title: "SELECT y WHERE", duration: "25 min", free: true, videoId: "g817Gfhrq0U" }
      ]}
    ]
  },
  "kubernetes-docker": {
    ...
    curriculum: [
      { title: "Docker", lessons: [
        { title: "Containers básicos", duration: "30 min", free: true, videoId: "PbZ3171Ikz0" },
        { title: "Dockerfile", duration: "25 min", free: true, videoId: "PbZ3171Ikz0" }
      ]}
    ]
  },
  "penetration-testing": {
    ...
    curriculum: [
      { title: "Preparación", lessons: [
        { title: "Lab de pentesting", duration: "30 min", free: true, videoId: "Uaw4dEgPMqc" },
        { title: "Metodología PTES", duration: "25 min", free: true, videoId: "Uaw4dEgPMqc" }
      ]}
    ]
  },
  "network-security": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Modelo OSI y seguridad", duration: "25 min", free: true, videoId: "UGNCMfFmVgQ" },
        { title: "Herramientas de escaneo", duration: "30 min", free: true, videoId: "UGNCMfFmVgQ" }
      ]}
    ]
  },
  "react-native-mobile": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "React Native vs Flutter", duration: "20 min", free: true, videoId: "M5QY2_oz7m0" },
        { title: "Setup con Expo", duration: "25 min", free: true, videoId: "M5QY2_oz7m0" }
      ]}
    ]
  },
  "python-django": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación y primer proyecto", duration: "25 min", free: true, videoId: "kqtD5dpn9C8" },
        { title: "Models y ORM", duration: "35 min", free: true, videoId: "kqtD5dpn9C8" }
      ]}
    ]
  },
  "cloud-aws": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "AWS Global Infrastructure", duration: "20 min", free: true, videoId: "5GfRZJVa_jg" },
        { title: "Creando tu cuenta AWS", duration: "15 min", free: true, videoId: "5GfRZJVa_jg" }
      ]}
    ]
  },
  "malware-analysis": {
    ...
    curriculum: [
      { title: "Introducción", lessons: [
        { title: "Tipos de malware", duration: "25 min", free: true, videoId: "jXzJhOg2v6Y" },
        { title: "Setup de laboratorio", duration: "30 min", free: true, videoId: "jXzJhOg2v6Y" }
      ]}
    ]
  },
  "git-github-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "Instalación de Git", duration: "10 min", free: true, videoId: "X8gyZ1jGF1g", content: "Git es un sistema de control de versiones distribuido.\n\nInstalación:\nUbuntu: sudo apt install git\nMac: brew install git\nWindows: git-scm.com\n\nConfiguración:\ngit config --global user.name \"Tu Nombre\"\ngit config --global user.email \"tu@email.com\"\n\nComandos básicos:\ngit init - Inicializar repositorio\ngit add . - Agregar archivos\ngit commit -m \"mensaje\" - Guardar cambios\ngit status - Ver estado\ngit log - Ver historial" },
        { title: "Primer commit", duration: "15 min", free: true, videoId: "X8gyZ1jGF1g" }
      ]}
    ]
  },
  "typescript-complete": {
    ...
    curriculum: [
      { title: "Fundamentos", lessons: [
        { title: "¿Por qué TypeScript?", duration: "15 min", free: true, videoId: "F14M_3fzsbY" },
        { title: "Tipos básicos", duration: "25 min", free: true, videoId: "F14M_3fzsbY" }
      ]}
    ]
  },
};
